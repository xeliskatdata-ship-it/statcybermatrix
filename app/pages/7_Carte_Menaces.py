...
SOURCE_GEO = {
    ...
    "CERT-EU Advisories":        ("Belgium", 50.8, 4.4),
    "CERT-BE Advisories":        ("Belgium", 50.8, 4.4),
    "Canadian Cyber Centre Alerts": ("Canada", 45.4, -75.7),
    "NCSC NL Advisories":        ("Netherlands", 52.1, 5.3),
    "NCSC NL News":              ("Netherlands", 52.1, 5.3),
    "CSIRT Italia":              ("Italy", 41.9, 12.5),
    "CERT-SE":                   ("Sweden", 59.3, 18.1),
    "Kaspersky Daily":           ("Russia", 55.7, 37.6),
    "The Register Security":     ("UK", 51.5, -0.1),
    "Security Boulevard":        ("USA", 40.7, -74.0),
    "Global Security Mag":       ("France", 48.8, 2.3),
    "CyberWire Daily":          ("USA", 39.2, -76.6),
    "Didier Stevens":           ("Belgium", 50.8, 4.4),
    "CERT.br (Brésil)":         ("Brazil", -15.8, -47.9),
    "CISA ICS Advisories":      ("USA", 38.9, -77.0),
    "CERT-FR Alertes":          ("France", 48.8, 2.3),
    "CERT-FR Avis":             ("France", 48.8, 2.3),
    "Arctic Wolf Labs":         ("USA", 44.9, -93.3),
    "Varonis Blog":             ("USA", 40.7, -74.0),
    "PortSwigger Research":     ("UK", 54.0, -2.0),
    "Snyk Research":            ("UK", 51.5, -0.1),
    "CERT-UA":                  ("Ukraine", 50.4, 30.5),
    "Silverfort Blog":          ("Israel", 32.1, 34.8),
    "Veeam Blog":               ("USA", 38.9, -77.2),
    "Exabeam Blog":             ("USA", 37.4, -122.1),
    "Darknet Diaries":          ("USA", 37.1, -95.7),
    "Smashing Security":        ("UK", 51.5, -0.1),
}
