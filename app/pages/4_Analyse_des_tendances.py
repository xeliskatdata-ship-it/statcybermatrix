# 4_kpi4_Analyse_Tendances.py -- Version CTI Expert - Correction URL et Sources
...
from db_connect import get_mart_k4, get_stg_articles # Import de get_stg_articles pour les sources
...
with st.sidebar:
    ...
    cats_dispo = sorted(df_mart['category'].unique().tolist())
...
data_trend = df_filtered[df_filtered['category']